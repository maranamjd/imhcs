              ...
              <?php if ($this->count($this->data) > 0): ?>
                <?php foreach ($this->data as $patient): ?>
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $patient['id']; ?>" id="edit"><i class="fa fa-edit"></i> Edit</button>
                      <button class="btn btn-danger btn-sm delete btn-flat" data-id="<?php echo $patient['id']; ?>" id="delete"><i class="fa fa-trash"></i> Delete</button>
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php endif; ?>
